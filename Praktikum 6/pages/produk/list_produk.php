...
?>
      ...
      <a class="btn btn-success" href="../../pages/produk/form_produk.php" role="button">Create Produk</a>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?=$row['stok']?></td>
                        <td>
<a class="btn btn-primary" href="../../pages/produk/view_produk.php?id=<?=$row['id']?>">View</a>
